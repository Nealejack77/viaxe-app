...
const makeStyles = (t: Tokens) => StyleSheet.create({
  ...
  textIn: { flex: 1, backgroundColor: t.glass, borderWidth: 1, borderColor: t.glassBorder, borderRadius: 4, paddingHorizontal: 16, paddingVertical: 10, fontSize: 14, color: t.text, maxHeight: 100 },
  sendBtn: { width: 40, height: 40, backgroundColor: t.red, borderRadius: 4, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  emptyWrap: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 32 },
  emptyIcon: { fontSize: 36, marginBottom: 12 },
  emptyTitle: { fontFamily: 'BarlowCondensed-Black', fontSize: 22, color: t.text, marginBottom: 6, textAlign: 'center', textTransform: 'uppercase' },
